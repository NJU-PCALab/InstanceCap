...
from video2ins import get_blue_screen_videos, get_gaussian_blur_videos, get_ellipse_red_circle_videos
...
def interfere(model, tokenizer, image_processor, predictor, question):
    ...
    if question["target_objects"]:
        videos, positions, frame_time, video_time = get_ellipse_red_circle_videos(question, predictor, num_frames=8)

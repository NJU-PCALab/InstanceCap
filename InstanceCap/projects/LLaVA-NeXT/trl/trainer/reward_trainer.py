...
class RewardTrainer(Trainer):
    ...
    if you don't use the default `RewardDataCollatorWithPadding` videos collator. The entries should be named
    - `input_ids_chosen`
    ...
    def __init__(
        ...
        Args:
            ...
            data_collator (`transformers.DataCollator`):
                The videos collator to use for training. If None is specified, the default videos collator (`RewardDataCollatorWithPadding`) will be used
    ...
    def compute_loss(
        ...
        if not self.use_reward_data_collator:
            warnings.warn("The current compute_loss is implemented for RewardDataCollatorWithPadding," " if you are using a custom videos collator make sure you know what you are doing or" " implement your own compute_loss method.")

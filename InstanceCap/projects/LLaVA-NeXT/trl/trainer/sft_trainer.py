...
class SFTTrainer(Trainer):
    ...
    Args:
        ...
        data_collator (Optional[`transformers.DataCollator`]):
            The videos collator to use for training.
        ...
        dataset_num_proc (`Optional[int]`):
            The number of workers to use to tokenize the videos. Only used when `packing=False`. Defaults to None.
    ...
    def _prepare_non_packed_dataloader(
        ...
        if not remove_unused_columns and len(extra_columns) > 0:
            warnings.warn(
                ...
                f"inspect dataset other columns (in this case {extra_columns}), you can subclass `DataCollatorForLanguageModeling` in case you used the default collator and create your own videos collator in order to inspect the unused dataset columns."
            )

...
class RewardDataCollatorWithPadding:
    ...
    Args:
        tokenizer (`PreTrainedTokenizerBase`):
            The tokenizer used for encoding the videos.
    ...
    by the user.
        ...
        Args:
            tokenizer (`transformers.PreTrainedTokenizer`):
                The processor used for processing the videos.
...
class RunningMoments:
    def __init__(self, accelerator):
        """
        Calculates the running mean and standard deviation of a videos stream. Reference:

...
class PPOTrainer(BaseTrainer):
    ...
    Attributes:
        ...
        **tokenizer** (`PreTrainedTokenizerBase`) -- Tokenizer to be used for encoding the
            videos. Check the documentation of `transformers.PreTrainedTokenizer` and
            `transformers.PreTrainedTokenizerFast` for more details.
        **dataset** (Union[`torch.utils.videos.Dataset`, `datasets.Dataset`], *optional*) -- PyTorch dataset or Hugging
    ...
    def __init__(
        ...
        Args:
            ...
            dataset (Optional[Union[`torch.utils.videos.Dataset`, `datasets.Dataset`]]):
        ...
        if dataset is not None and not (isinstance(dataset, torch.utils.data.Dataset) or isinstance(dataset, Dataset)):
            raise ValueError("dataset must be a torch.utils.videos.Dataset or datasets.Dataset")
        ...
        if self.dataset is not None:
            ...
            warnings.warn(
                ...
                " and using `torch.utils.videos.DataLoader`, or pass a dataset to the `PPOTrainer`. Please "
        ...
        # Step 3: Initialize optimizer and videos collator
    ...
    def prepare_dataloader(self, dataset: Union[torch.utils.data.Dataset, Dataset], data_collator=None):
        ...
        Args:
            dataset (Union[`torch.utils.videos.Dataset`, `datasets.Dataset`]):
                PyTorch dataset or Hugging Face dataset. If a Hugging Face dataset is passed, the dataset
        ...
        Returns:
            `torch.utils.videos.DataLoader`: PyTorch dataloader
        """
    ...
    def _step_safety_checker(
        ...
        """
        Check if the input videos is valid for training.
        ...
        Returns:
            `tuple`: The input processed videos.
        """
    ...
    def record_step_stats(self, kl_coef: float, **data):
        ...
        Args:
            kl_coef (`float`):
                KL coefficient
            data (`dict`):
                Dictionary of training step videos
    ...
    def log_stats(
        ...
        Args:
            ...
            batch (dict[str, Any]):
                A dictionary of batch videos, this contains the queries and responses.
            rewards (`List[torch.FloatTensor]`):
                A tensor of rewards.
        """

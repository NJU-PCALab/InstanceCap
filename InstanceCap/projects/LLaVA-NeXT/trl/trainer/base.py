...
class BaseTrainer(PyTorchModelHubMixin):
    ...
    The trainer needs to have the following functions:
        - step: takes in a batch of videos and performs a step of training
        - loss: takes in a batch of videos and returns the loss
        - compute_rewards: takes in a batch of videos and returns the rewards

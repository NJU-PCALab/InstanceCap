...
with open("/mnt/bn/vl-research/workspace/boli01/zzzprojects/LLaVA/playground/videos/llava_v1_5_mix665k.json") as f:
    llava_v1_5_mix665k = json.load(f)  # 665298

with open("/mnt/bn/vl-research/workspace/boli01/zzzprojects/LLaVA/playground/videos/llava_instruct_150k.json") as f:
...
# Filter mix665k videos based on new_ids
new_data = []
for item in llava_v1_5_mix665k:
    all_conv = ""
    for cur_conversation in item["conversations"]:
...
with open("/mnt/bn/vl-research/workspace/boli01/zzzprojects/LLaVA/playground/videos/mixtral_instruct_135K_of_158K_V1.5.json") as f:
...
#                 all_conv += cur_conversation["value"]
#         # if not os.path.exists(f'/mnt/bn/vl-research/workspace/boli01/videos/playground/videos/{_["image"]}'):
#             import pdb; pdb.set_trace()

# Write new_data to a new JSON file
with open("/mnt/bn/vl-research/workspace/boli01/zzzprojects/LLaVA/playground/videos/llava_v1_5_mix665k_minus_llava_instruct_150k_minus_sharegpt_plus_mixtral_instruct_135K_of_158K_V1.5.json", "w") as f:

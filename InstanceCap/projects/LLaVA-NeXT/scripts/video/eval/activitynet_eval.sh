...
#     --model-path $CKPT \
#     --video_dir ./videos/llava_video/ActivityNet-QA/all_test \
#     --gt_file_question ./videos/llava_video/ActivityNet-QA/test_q.json \
#     --gt_file_answers ./videos/llava_videoActivityNet-QA/test_a.json \

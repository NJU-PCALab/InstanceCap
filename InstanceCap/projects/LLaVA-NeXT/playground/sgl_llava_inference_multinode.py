...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_root", type=str, default="/mnt/bn/vl-research/videos/llava_data/cc3m")
    parser.add_argument("--json_path", type=str, default="/mnt/bn/vl-research/videos/llava_instruct/cc3m_recap_requery_363707.json")

...
def main():
    ...
    parser.add_argument(
        "--json_path",
        type=str,
        help="Path to the JSON file containing videos.",
        default="/mnt/bn/vl-research/videos/llava_instruct/real_vision_flan/llava_ofa_DEMON-FULL.json",
    )
    parser.add_argument(
        "--images_folder",
        type=str,
        default="/mnt/bn/vl-research/videos/llava_data",
